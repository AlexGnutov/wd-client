...
function TicketPage() {
    ...
    const { filmTitle, hallTitle, startTime, seats } = ticketInformation;
        ...
        <section className="ticket">
            ...
            <div className="ticket__info-wrapper">
                <p className="ticket__info">На фильм:
                    <span className="ticket__details ticket__title"> {filmTitle}</span>
                </p>
                <p className="ticket__info">Места:
                    <span className="ticket__details ticket__chairs"> {places}</span>
                </p>
                <p className="ticket__info">В зале:
                    <span className="ticket__details ticket__hall"> {hallTitle}</span>
                </p>
                <p className="ticket__info">Начало сеанса:
                    <span className="ticket__details ticket__start"> {minutesToTimeString(startTime)}</span>
                </p>
